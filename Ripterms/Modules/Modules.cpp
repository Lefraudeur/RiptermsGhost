...
static void sendPacket_callback(void* sp, void* j_rarg0, void* j_rarg1, void* j_rarg2, void* j_rarg3, void* j_rarg4, void* j_rarg5, bool* should_return, void* rbx, void* reserved, void* r13) //j_rarg0 is this object in non static methods
{
	...
	if (!env)
		return;
	jobject packet_o = Ripterms::JavaHook::j_rarg_to_jobject(j_rarg1, reserved);
	if (!packet_o)
		return;
