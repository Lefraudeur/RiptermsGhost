...
float GameSettings::getGammaSetting()
{
	...
	if (Ripterms::majorVersion == Ripterms::Version::MAJOR_1_16_5) {
		return Ripterms::p_env->GetDoubleField(instance, Ripterms::classcache->GameSettingsClass.fields["gammaSetting"]);
	}
	return (float)Ripterms::p_env->GetFloatField(instance, Ripterms::classcache->GameSettingsClass.fields["gammaSetting"]);
}
